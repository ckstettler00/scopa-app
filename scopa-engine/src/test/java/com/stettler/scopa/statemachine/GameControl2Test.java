...
public class GameControl2Test {
    ...
    GameControl2 control = new GameControl2();
    ...
    void testEmptyHands() throws Exception {
        ...
        this.control.play(player1Id, new Pickup(new Card(1, Suit.CUPS),
        ...
        control.play(player2Id, new Pickup(new Card(2, Suit.SWORDS),
    ...
    void testLastTrick() throws Exception {
        ...
        this.control.play(player1Id, new Discard(new Card(10, Suit.CUPS)));
        ...
        this.control.play(player2Id, new Pickup(new Card(4, Suit.SWORDS),
        ...
        // Playing a pickup should switch the lastTrick indicator.
        this.control.play(player1Id, new Pickup(new Card(3, Suit.CUPS),
    ...
    void testPlayOutOfTurn() throws Exception {
        ...
        this.control.play(player2Id, new Pickup(new Card(1, Suit.SWORDS),
                new ArrayList<>(Arrays.asList(new Card(1, Suit.COINS)))));
...
//
    ...
    private void newGameAndRegistration() throws Exception {
        ...
        control.registerPlayer(createPlayer1Details(), player1);
        control.registerPlayer(createPlayer2Details(), player2);
